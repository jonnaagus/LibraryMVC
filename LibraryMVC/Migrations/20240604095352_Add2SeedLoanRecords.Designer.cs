...
namespace LibraryMVC.Migrations
{
    ...
    [Migration("20240604095352_Add2SeedLoanRecords")]
    partial class Add2SeedLoanRecords
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LibraryMVC.Models.LoanRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LoanRecordId = 1,
                            BookItemId = 2,
                            BorrowDate = new DateTime(2024, 5, 30, 11, 53, 51, 929, DateTimeKind.Local).AddTicks(2006),
                            LibraryMemberId = 1
                        },
                        new
                        {
                            LoanRecordId = 2,
                            BookItemId = 1,
                            BorrowDate = new DateTime(2024, 5, 23, 11, 53, 51, 929, DateTimeKind.Local).AddTicks(2083),
                            LibraryMemberId = 2
                        },
                        new
                        {
                            LoanRecordId = 3,
                            BookItemId = 4,
                            BorrowDate = new DateTime(2024, 5, 25, 11, 53, 51, 929, DateTimeKind.Local).AddTicks(2085),
                            LibraryMemberId = 3
                        });
                });
